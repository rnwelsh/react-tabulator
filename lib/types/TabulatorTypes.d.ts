declare namespace Tabulator {
    interface Options extends OptionsGeneral, OptionsMenu, OptionsHistory, OptionsLocale, OptionsDownload, OptionsColumns, OptionsRows, OptionsData, OptionsSorting, OptionsFiltering, OptionsRowGrouping, OptionsPagination, OptionsPersistentConfiguration, OptionsClipboard, OptionsDataTree, OptionsCell, OptionsCells, OptionsDebug, OptionsHTML {
    }
    ...
    interface OptionsClipboard {
        ...
        groupHeaderClipboard?: ((value: any, count: number, data: any, group: GroupComponent) => string) | Array<(value: any, count: number, data: any) => string> | undefined;
        ...
        groupHeaderHtmlOutput?: ((value: any, count: number, data: any, group: GroupComponent) => string) | Array<(value: any, count: number, data: any) => string> | undefined;
    }
    ...
    interface OptionsRowGrouping {
        ...
        groupHeader?: ((value: any, count: number, data: any, group: GroupComponent) => string) | Array<(value: any, count: number, data: any) => string> | undefined;
        ...
        groupHeaderPrint?: ((value: any, count: number, data: any, group: GroupComponent) => string) | Array<(value: any, count: number, data: any) => string> | undefined;
        /**
    ...
    interface OptionsRows {
         ...
         */
        movableRowsSender?: false | 'delete' | ((fromRow: RowComponent, toRow: RowComponent, toTable: Tabulator) => any) | undefined;
        /**
         ...
         */
        movableRowsReceiver?: 'insert' | 'add' | 'update' | 'replace' | ((fromRow: RowComponent, toRow: RowComponent, fromTable: Tabulator) => any) | undefined;
    ...
    interface OptionsColumns {
        ...
        autoColumnsDefinitions?: ((columnDefinitions?: ColumnDefinition[]) => ColumnDefinition[]) | ColumnDefinition[] | Record<string, Partial<ColumnDefinition>> | undefined;
    ...
    type RowContextMenuSignature = Array<MenuObject<RowComponent> | MenuSeparator> | ((e: MouseEvent, component: RowComponent) => MenuObject<RowComponent> | false | any[]);
    type GroupContextMenuSignature = Array<MenuObject<GroupComponent> | MenuSeparator> | ((component: GroupComponent, e: MouseEvent) => MenuObject<GroupComponent> | false | any[]);
    ...
    interface OptionsHTML {
        ...
        groupHeaderDownload?: ((value: any, count: number, data: any, group: GroupComponent) => string) | Array<(value: any, count: number, data: any) => string> | undefined;
    }
    ...
    interface ColumnDefinition extends ColumnLayout, CellCallbacks {
         ...
         */
        sorter?: 'string' | 'number' | 'alphanum' | 'boolean' | 'exists' | 'date' | 'time' | 'datetime' | 'array' | ((a: any, b: any, aRow: RowComponent, bRow: RowComponent, column: ColumnComponent, dir: SortDirection, sorterParams: {}) => number) | undefined;
        ...
        cellPopup?: string | ((e: MouseEvent, component: RowComponent | CellComponent | ColumnComponent, onRendered: () => any) => any);
    ...
    type CustomAccessor = (value: any, data: any, type: 'data' | 'download' | 'clipboard', AccessorParams: any, column?: ColumnComponent, row?: RowComponent) => any;
    type CustomAccessorParams = {} | ((value: any, data: any, type: 'data' | 'download' | 'clipboard', column?: ColumnComponent, row?: RowComponent) => any);
    type ColumnCalc = 'avg' | 'max' | 'min' | 'sum' | 'concat' | 'count' | ((values: any[], data: any[], calcParams: {}) => any);
    ...
    type Editor = true | 'input' | 'textarea' | 'number' | 'range' | 'tickCross' | 'star' | 'list' | 'list' | 'date' | 'time' | 'datetime' | ((cell: CellComponent, onRendered: EmptyCallback, success: ValueBooleanCallback, cancel: ValueVoidCallback, editorParams: {}) => HTMLElement | false);
    type EditorParams = NumberParams | CheckboxParams | ListEditorParams | InputParams | TextAreaParams | DateParams | TimeParams | DateTimeEditorParams | ((cell: CellComponent) => {});
    type ScrollToRowPosition = 'top' | 'center' | 'bottom' | 'nearest';
    type PopupPosition = ColumnDefinitionAlign | 'top' | 'bottom';
    ...
    interface DateParams extends SharedEditorParams {
        min?: string;
        max?: string;
        format?: string;
    }
    interface TimeParams extends SharedEditorParams {
        format?: string;
    }
    interface DateTimeEditorParams extends SharedEditorParams {
        format?: string;
    }
    ...
    interface ListEditorParams extends SharedEditorParams, SharedSelectAutoCompleteEditorParams {
...
export interface EventCallBackMethods {
    ...
    rowMouseDown: (event: UIEvent, row: Tabulator.RowComponent) => void;
    rowMouseUp: (event: UIEvent, row: Tabulator.RowComponent) => void;
    ...
    headerMouseUp: (event: UIEvent, column: Tabulator.ColumnComponent) => void;
    headerMouseDown: (event: UIEvent, column: Tabulator.ColumnComponent) => void;
    ...
    groupMouseDown: (event: UIEvent, group: Tabulator.GroupComponent) => void;
    groupMouseUp: (event: UIEvent, group: Tabulator.GroupComponent) => void;
    tableBuilding: () => void;
    tableBuilt: () => void;
    tableDestroyed: () => void;
    ...
    cellMouseDown: (event: UIEvent, cell: Tabulator.CellComponent) => void;
    cellMouseUp: (event: UIEvent, cell: Tabulator.CellComponent) => void;
    ...
    dataProcessing: () => void;
    dataProcessed: () => void;
    popupOpen: (cell: Tabulator.CellComponent) => void;
    popupClosed: (cell: Tabulator.CellComponent) => void;
    menuClosed: (cell: Tabulator.CellComponent) => void;
    menuOpened: (cell: Tabulator.CellComponent) => void;
}
declare class Tabulator {
     ...
     */
    download: (downloadType: Tabulator.DownloadType | ((columns: Tabulator.ColumnDefinition[], data: any, options: any, setFileContents: any) => any), fileName: string, params?: Tabulator.DownloadOptions, filter?: Tabulator.RowRangeLookup) => void;
    ...
    getHtml: (rowRangeLookup?: Tabulator.RowRangeLookup, style?: boolean, config?: Tabulator.AdditionalExportOptions) => any;
    ...
    print: (rowRangeLookup?: Tabulator.RowRangeLookup, style?: boolean, config?: Tabulator.AdditionalExportOptions) => any;
    /**
    ...
    /** To receive the DOM Node of a specific row, you can retrieve the Tabulator.RowComponent with the getRow function, then use the getElement function on the component. The first argument is the row you are looking for, it will take any of the standard row component look up options. */
     ...
     */
    scrollToRow: (row: Tabulator.RowLookup, position?: Tabulator.ScrollToRowPosition, ifVisible?: boolean) => Promise<void>;
    /**
     ...
     */
    getRowPosition: (row: Tabulator.RowLookup, activeOnly?: boolean) => number | false;
    ...
    /** Using the getColumn function you can retrieve the Tabulator.Column Component. */
     ...
     */
    addColumn: (definition: Tabulator.ColumnDefinition, insertRightOfTarget?: boolean, positionTarget?: Tabulator.ColumnLookup) => Promise<void>;
     ...
     */
    setFilter: (p1: string | Tabulator.Filter[] | any[] | ((data: any, filterParams: any) => boolean), p2?: Tabulator.FilterType | {}, value?: any, filterParams?: Tabulator.FilterParams) => void;
    ...
    /** You can use the getGroups function to retrieve an array of all the first level Tabulator.Group Components in the table. */
...
export { Module, AccessorModule, AjaxModule, ClipboardModule, ColumnCalcsModule, DataTreeModule, DownloadModule, EditModule, ExportModule, FilterModule, FormatModule, FrozenColumnsModule, FrozenRowsModule, GroupRowsModule, HistoryModule, HtmlTableImportModule, InteractionModule, KeybindingsModule, MenuModule, MoveColumnsModule, MoveRowsModule, MutatorModule, PageModule, PersistenceModule, PopupModule, PrintModule, PseudoRow, ReactiveDataModule, Renderer, ResizeColumnsModule, ResizeRowsModule, ResizeTableModule, ResponsiveLayoutModule, SelectRowModule, SortModule, Tabulator, TabulatorFull, TooltipModule, ValidateModule, };
